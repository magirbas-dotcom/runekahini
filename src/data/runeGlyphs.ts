...
/** Places a glyph centred in a 100x100 viewBox. */
export function glyphTransform(glyph: RuneGlyph, scale: number = GLYPH_FIT_SCALE): string {
  const x = (50 - glyph.cx * scale).toFixed(2);
